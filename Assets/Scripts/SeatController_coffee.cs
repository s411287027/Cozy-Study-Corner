...
public class SeatManager_Coffee : MonoBehaviour
{
    ...
    // 保存目前顯示按鈕的 ClickArea
    private SeatClickArea_Cafe activeClickArea = null;

    // ⭐ 點擊座位顯示按鈕
    public void OnSeatClicked(string seatId, SeatClickArea_Cafe clickArea)
    {
        string path = $"Seat/Coffee/{currentRoomID}/{seatId}";
