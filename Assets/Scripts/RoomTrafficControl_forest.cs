...
public class RoomTrafficControl_forest : MonoBehaviour
{
    public SeatAvatar_forest avatarController; // 負責顯示
    public SeatManager_Forest interactionController; // 負責按鈕與寫入

    // 定義最大人數
    private const int MAX_SEATS = 5;
    ...
    public void CheckRoomStatusAndConnect(string roomId)
    {
        ...
        FirebaseDatabase.DefaultInstance
            .GetReference($"Seat/Forest/{roomId}")
            .GetValueAsync()
