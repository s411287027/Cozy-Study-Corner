...
public class ShopController : MonoBehaviour
{
    ...
    private void InitializeShopItems()
    {
        ...
        shopItems = new List<ShopItem>
        {
            ...
            new ShopItem { itemType = "shoes", itemId = 6, price = 1000, icon = Resources.Load<Sprite>("Wardrobe/shoes/6") },
            ...
            new ShopItem { itemType = "furniture", itemId = 2, price = 150, icon = Resources.Load<Sprite>("Book-1-1") },
            new ShopItem { itemType = "furniture", itemId = 3, price = 120, icon = Resources.Load<Sprite>("Book-2-1") },
            new ShopItem { itemType = "furniture", itemId = 4, price = 180, icon = Resources.Load<Sprite>("Cabinet-1-1") },
            new ShopItem { itemType = "furniture", itemId = 5, price = 1500, icon = Resources.Load<Sprite>("Carpet-1-1") },
            new ShopItem { itemType = "furniture", itemId = 6, price = 300, icon = Resources.Load<Sprite>("Chair-1-1") },
            new ShopItem { itemType = "furniture", itemId = 7, price = 200, icon = Resources.Load<Sprite>("Clock-1-1") },
            new ShopItem { itemType = "furniture", itemId = 8, price = 160, icon = Resources.Load<Sprite>("Closet-1-1") },
            new ShopItem { itemType = "furniture", itemId = 9, price = 420, icon = Resources.Load<Sprite>("Cup-1-1") },
            new ShopItem { itemType = "furniture", itemId = 10, price = 100, icon = Resources.Load<Sprite>("Desk-1-1") },
            new ShopItem { itemType = "furniture", itemId = 11, price = 1200, icon = Resources.Load<Sprite>("Doll-1-1") },
            new ShopItem { itemType = "furniture", itemId = 12, price = 170, icon = Resources.Load<Sprite>("Lamp-1-1") },
            new ShopItem { itemType = "furniture", itemId = 13, price = 135, icon = Resources.Load<Sprite>("Pillow-1-1") },
            new ShopItem { itemType = "furniture", itemId = 14, price = 110, icon = Resources.Load<Sprite>("Plant-1-1") },
            new ShopItem { itemType = "furniture", itemId = 15, price = 75, icon = Resources.Load<Sprite>("Plant-2-1") },
            new ShopItem { itemType = "furniture", itemId = 16, price = 100, icon = Resources.Load<Sprite>("Shelf-1-1") },
            new ShopItem { itemType = "furniture", itemId = 17, price = 160, icon = Resources.Load<Sprite>("Shelf-2-1") },
            new ShopItem { itemType = "furniture", itemId = 18, price = 400, icon = Resources.Load<Sprite>("Sofa-1-1") },
            new ShopItem { itemType = "furniture", itemId = 19, price = 150, icon = Resources.Load<Sprite>("Table-1-1") },
            new ShopItem { itemType = "furniture", itemId = 20, price = 120, icon = Resources.Load<Sprite>("Toy-1-1") },
            new ShopItem { itemType = "furniture", itemId = 21, price = 130, icon = Resources.Load<Sprite>("Window-1-1") },
            new ShopItem { itemType = "furniture", itemId = 22, price = 400, icon = Resources.Load<Sprite>("Window-2-1") }
