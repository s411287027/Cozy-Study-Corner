...
public class RoomTrafficControl_camp : MonoBehaviour
{
    public SeatAvatar_camp avatarController; // 負責顯示
    public SeatManager_Camp interactionController; // 負責按鈕與寫入
