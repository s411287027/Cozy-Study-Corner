...
public class RoomTrafficControl_classroom : MonoBehaviour
{
    public SeatAvatar_classroom avatarController; // 負責顯示
    public SeatManager_Classroom interactionController; // 負責按鈕與寫入

    // 定義最大人數
    private const int MAX_SEATS = 12;
    ...
    public void CheckRoomStatusAndConnect(string roomId)
    {
        ...
        FirebaseDatabase.DefaultInstance
            .GetReference($"Seat/Classroom/{roomId}")
            .GetValueAsync()
