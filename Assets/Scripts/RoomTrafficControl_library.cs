...
public class RoomTrafficControl_library : MonoBehaviour
{
    public SeatAvatar_library avatarController; // 負責顯示
    public SeatManager_Library interactionController; // 負責按鈕與寫入
    ...
    public void CheckRoomStatusAndConnect(string roomId)
    {
        ...
        FirebaseDatabase.DefaultInstance
            .GetReference($"Seat/Library/{roomId}")
            .GetValueAsync()
