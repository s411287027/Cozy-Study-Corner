...
public class RoomTrafficControl_swimmingpool : MonoBehaviour
{
    public SeatAvatar_swimmingpool avatarController; // 負責顯示
    public SeatManager_Swimmingpool interactionController; // 負責按鈕與寫入

    // 定義最大人數
    private const int MAX_SEATS = 6;
    ...
    public void CheckRoomStatusAndConnect(string roomId)
    {
        ...
        FirebaseDatabase.DefaultInstance
            .GetReference($"Seat/Swimmingpool/{roomId}")
            .GetValueAsync()
